 ...
 */
import { createJob, type JobResponse } from "@/api/client";
...
type PipelineType = "single_stage" | "two_stage";
type ModelArch = "unet" | "double_unet";
...
export default function ConfigPage() {
  ...
  async function handleSubmit() {
    ...
    setSubmitting(true);
    try {
      const job: JobResponse = await createJob(files, pipeline, arch);
